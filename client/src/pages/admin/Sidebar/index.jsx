            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  ...
                  <path
                    d="M4 2C3.447 2 3 2.447 3 3V21C3 21.553 3.447 22 4 22H20C20.553 22 21 21.553 21 21V8.828C21 8.297 20.789 7.789 20.414 7.414L16.586 3.586C16.211 3.211 15.703 3 15.172 3H4Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    fill="none"
                  />
                  ...
                  />
                  <path
                    d="M11.5 13C11.5 13.828 12.172 14.5 13 14.5H13.5V14C13.5 12.895 12.605 12 11.5 12H11C10.895 12 10.5 12.224 10.5 13H11.5Z"
                    fill="currentColor"
                  />
                </svg>
                  Test
              ...
              <li>
                <NavLink
                  to="/dashbord/lecturer"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('lecturare') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
...
>
  ...
  <path
    d="M5 20C5 16.686 8.134 14 12 14C15.866 14 19 16.686 19 20H5Z"
    stroke="currentColor"
    strokeWidth="2"
    fill="none"
  />
  <line x1="19" y1="4" x2="19" y2="10" stroke="currentColor" strokeWidth="2" />
  <line x1="16" y1="7" x2="22" y2="7" stroke="currentColor" strokeWidth="2" />

  <rect x="8" y="15" width="8" height="2" stroke="currentColor" strokeWidth="2" fill="none" />
  <line x1="8" y1="15" x2="8" y2="17" stroke="currentColor" strokeWidth="2" />
  <line x1="16" y1="15" x2="16" y2="17" stroke="currentColor" strokeWidth="2" />
                  </svg>
              ...
              <li>
                <NavLink
                  to="/dashbord/condidate"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('condidate') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                  ...
                  >
                    ...
                    <path
                      d="M8 18C8 16 10 14 12 14C14 14 16 16 16 18"
                      stroke="currentColor"
                      strokeWidth="2"
                      fill="none"
                    />
                    <path
                      d="M8 18L8 20L16 20L16 18"
                      stroke="currentColor"
                      strokeWidth="2"
                      fill="none"
                    />
                    <path
                      d="M10 20L10 22L14 22L14 20"
                      stroke="currentColor"
                      strokeWidth="2"
                      fill="none"
                    />
              ...
              <li>
                ...
                >
                  ...
                  >
                    ...
                    <rect x="5" y="3" width="14" height="18" stroke="currentColor" strokeWidth="2" fill="none" />
                    <line x1="5" y1="6" x2="19" y2="6" stroke="currentColor" strokeWidth="2" />
                    <line x1="5" y1="9" x2="19" y2="9" stroke="currentColor" strokeWidth="2" />
                    <line x1="5" y1="12" x2="19" y2="12" stroke="currentColor" strokeWidth="2" />
                    <line x1="5" y1="15" x2="19" y2="15" stroke="currentColor" strokeWidth="2" />
                    ...
                    <line x1="12" y1="5" x2="12" y2="7" stroke="currentColor" strokeWidth="2" />
                    <path
                      d="M12 9C13.104 9 14 9.896 14 11C14 12.104 13.104 13 12 13C10.896 13 10 12.104 10 11C10 9.896 10.896 9 12 9Z"
                      stroke="currentColor"
                      strokeWidth="2"
                      fill="none"
                    />
