  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats title="All Test" total="456" rate="0.43%" levelUp routCard={"tests"}>
          <FaClipboardList className="text-primary dark:text-white" size={22}  />
        </CardDataStats>
        <CardDataStats title="All Lecturer" total="45" rate="4.35%" levelUp routCard={"lecturer"}>
          <FaChalkboardTeacher className="text-primary dark:text-white" size={22} />
        </CardDataStats>
        <CardDataStats title="All Candidate" total="250" rate="2.59%" levelUp routCard={"condidate"}>
          <FaUserGraduate className="text-primary dark:text-white" size={22} />
        </CardDataStats>
        <CardDataStats title="Question Bank" total="356" rate="0.95%" levelDown routCard={"question-bank"}>
