                ...
                <td className="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 3.487a2.25 2.25 0 113.182 3.182L7.011 19.702a4.5 4.5 0 01-1.697 1.065l-3.114.925.925-3.114a4.5 4.5 0 011.065-1.697L16.862 3.487zm0 0L20.25 6.75m-4.5-2.25l-1.5 1.5"/>
                    </svg>
                    </button>
                  </div>
                </td>
