...
const AddQuestion = () => {
  ...
  const formik = useFormik({
    initialValues: {
      question: "",
      options: category === "Listening" ? ["", ""] : ["", "", "", ""], // Default 2 for Listening, 4 otherwise
      correctAnswer: "",
      listeningFile: null,
    },
    validationSchema: Yup.object({
      ...
      options: Yup.array()
        ...
        .min(category === "Listening" ? 2 : 4, "Minimum required options not met"),
        ...
        >
          ...
          <div className="col-span-2">
            ...
            <textarea
              ...
              rows="4"
              className={ `w-full rounded-lg border-[1.5px] ${formik.touched.question && formik.errors.question ? "border-red-500" : "border-stroke"
          ...
          {/* Number of Options Selection (Only for Listening) */ }
          { category === "Listening" && (
            <div className="col-span-2">
              <label className="mb-3 block text-black dark:text-white">Number of Options</label>
              <select
                value={ formik.values.options.length }
                onChange={ (e) => {
                  const numOptions = parseInt(e.target.value, 10);
                  formik.setFieldValue("options", new Array(numOptions).fill(""));
                } }
                className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
              >
          ...
          <div className="col-span-2 grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={ formik.handleChange }
                onBlur={ formik.handleBlur }
                className={ `w-full rounded-lg border-[1.5px] ${formik.touched.correctAnswer && formik.errors.correctAnswer ? "border-red-500" : "border-stroke"
                  } bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary` }
              >
